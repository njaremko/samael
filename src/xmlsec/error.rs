...
impl std::fmt::Display for XmlSecError
{
    fn fmt(&self, fmt: &mut std::fmt::Formatter) -> std::fmt::Result
    {
        match self
        {
            ...
            Self::CryptoInitOpenSSLError  => write!(fmt, "{}", "Internal XmlSec Crypto OpenSSL Init Error"),
            Self::CryptoInitOpenSSLAppError  => write!(fmt, "{}", "Internal XmlSec Crypto OpenSSLApp Init Error"),
